...
You will be matched with other members on the kick-off day at 20.30 WIB`
    ...
    static reviewYourGoal({project,goal,about,shareProgressAt,coworkingTime,role,dayLeft,user}){
        return {
            content:"**REVIEW YOUR GOAL 📝**\n↓",
            embeds:[ this.templateEmbedMessageGoal({project,goal,about,shareProgressAt,coworkingTime,role,dayLeft,user}) ],
            components:[
                this.createComponent(
    ...
    static postGoal({project,goal,about,shareProgressAt,coworkingTime,role,dayLeft,user}){
        return {
            content:`from ${user}`,
            embeds:[ this.templateEmbedMessageGoal({project,goal,about,shareProgressAt,coworkingTime,role,dayLeft,user}) ],
...
Please use 24h for time format.`
    ...
    static templateEmbedMessageGoal({project,goal,about,shareProgressAt,coworkingTime,role,dayLeft,user}){
        const descriptionCoworkingTime = coworkingTime === "Morning"? "🌤️ Morning Club — co-working hour from 07.00 – 11.30 WIB " : "🌙 Night Club — co-working hour from 19.30 – 22.00  WIB"
        ...
        .addFields(
            ...
            { name: "Preferred co-working time", value: descriptionCoworkingTime },

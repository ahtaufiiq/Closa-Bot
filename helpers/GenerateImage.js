...
class GenerateImage{
    static async tracker(user,goalName,photo,data,friends,currentStreak,longestStreak,totalDays,totalPoints,isVacation=false,vacationLeft=0,isBuyOneVacation=false,isSick=false){
        ...
        const additionalStreak = isVacation ? '_vacation' : isSick ? "_sick" : longestStreak >= 365 ? '_365streak' : longestStreak >= 200 ? '_200streak' : longestStreak >= 100 ? '_100streak' : longestStreak >= 7 ? "_30streak" : ''
